...
ssid        =  wpa[0].info  #"SWI"
APmac       =  wpa[1].addr3 #a2b_hex("cebcc8fdcab7")
Clientmac   =  wpa[1].addr1 #a2b_hex("0013efd015bd")



# Authenticator and Supplicant Nonces
ANonce      = str(wpa[5][Raw]).encode("HEX")[26:90] #a2b_hex("90773b9a9661fee1f406e8989c912b45b029c652224e8b561417672ca7e0fd91")
SNonce      = str(wpa[6][Raw]).encode("HEX")[26:90] # a2b_hex("7b3826876d14ff301aee7c1072b5e9091e21169841bce9ae8a3f24628f264577")
